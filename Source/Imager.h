...
public:
	...
	Imager(
		...
		bool monoToStereo = false // TODO: implement. If true, do as now (just get the mono signal and convert it to stereo. If false, get stereo and process it as is (separate original and auxiliar left/right channels)
	);
	~Imager();
...
private:
	...
	// -- Imager
	std::array<float, SignalID::countSignals> gains{ 0.5f, 0.5f };
	float width{ 0.f };
	float center{ 0.f };
	float delayTime{ 0.f };
