	...
	meterR([&]() { return audioProcessor.getRmsValue(RIGHT_CHANNEL); })
{
	...
	setSize(800, 800 / ratio);
	setResizeLimits(600, 600 / ratio, 2000, 2000 / ratio);
...
//==============================================================================
void AuditoriumStereoEnhancerAudioProcessorEditor::paint(juce::Graphics& g)
{
...
//==============================================================================
void AuditoriumStereoEnhancerAudioProcessorEditor::addAndMakeVisibleComponents()
{
	// --- Sliders
